...
import { Truck, LocateFixed, BadgeDollarSign, ShieldCheck, Headset, Clock } from "lucide-react";
...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Competitive rates without hidden fees. Save up to 30% compared to other logistics providers.",
      icon: <BadgeDollarSign className="w-12 h-12 mb-4" />,
      color: "text-red-500"
    },
    {
