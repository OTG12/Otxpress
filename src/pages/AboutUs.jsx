      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center w-full">
                    ...
                    <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <div className="space-y-1">
                              <a href="tel:09064862817" className="block text-red-400 hover:text-white transition-colors">
                                +234 906 486 2817
                              </a>
                              <a href="tel:09036817576" className="block text-red-400 hover:text-white transition-colors">
                                +234 903 681 7576
                              </a>
                            </div>
                          </div>
        ...
        <div className="flex items-start">
              ...
              <div>
                ...
                <a href="mailto:otxpress23@gmail.com" className="text-red-400 hover:text-white transition-colors">
