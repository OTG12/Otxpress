        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-black border border-red-600 p-6 rounded-lg shadow-lg space-y-6">
            <div>
              ...
              <p className="text-red-400">33, Jago Plaza, Cele Bus Stop, Alagbole, Lagos</p>
            </div>

            <div>
              <h2 className="text-2xl font-bold mb-3">Call Us</h2>
              <p className="text-red-400">+234 906 486 2817</p>
              <p className="text-red-400">+234 903 681 7576</p>
            </div>

            <div>
              <h2 className="text-2xl font-bold mb-3">Email</h2>
              <p className="text-red-400">otxpress23@gmail.com</p>
            </div>

            <div>
              <h2 className="text-2xl font-bold mb-3">Working Hours</h2>
              <p className="text-red-400">Mon - Sat: 8AM - 5PM</p>
            </div>
          </div>
        </div>
      </div>
